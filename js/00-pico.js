/* 00-pico.js
   libreria pico.js per il riconoscimento dei volti (MIT) */

/* ---------- rilevamento del volto ----------
   pico.js di Nenad Markus, licenza MIT: https://github.com/nenadmarkus/picojs
   La cascata è incorporata qui sotto, così tutto funziona anche offline. */
...
/* =========================================================================
   IMPOSTAZIONI FISSE — cambiale una volta e restano per ogni partita
   ========================================================================= */
